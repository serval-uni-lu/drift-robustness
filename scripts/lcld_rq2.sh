...
do
  ...
  cp ./data/optimizer_results/lcld_201317_ds_time/rf_lcld_400/rq1.3/periodic_42_*_rf_lcld_400_200000_4W.json ./data/optimizer_results/lcld_201317_ds_time/rf_lcld_400/${rq}/

  # PLOT ON PARETO FRONT
  # REMOVE max_pareto_rank to see all points
